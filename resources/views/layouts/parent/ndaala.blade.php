...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('admin/css/cdn.css') }}" rel="stylesheet" crossorigin="anonymous" />
        <script src="{{ asset('admin/js/cdn.js') }}" crossorigin="anonymous"></script>
    </head>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="login.html">HABARI
                                                <span class="badge badge-light badge-pill" style="position: static;">9</span>

                                            </a>
                                            <a class="nav-link" href="register.html">TAARIFA ZA MALIPO</a>
                            ...
                            <a class="nav-link" href="https://api.whatsapp.com/send?phone=255712828561&text=Hello">
